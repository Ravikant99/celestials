...
var url="mongodb+srv://pushkar:pushkar@hello.xkgjn.mongodb.net/?retryWrites=true&w=majority";
var resu;
...
app.get("/api",function(req,res){
	...
	//console.log(resu.find({"_id" : ObjectId("5f8a9e693f267505b556909c")}));
	 resu.find({Category:"BUTTER"}).toArray(function(err, result) {
    if (err) throw err;
 res.render("type-n-speak/dist/index.html",{name:result[0].Description});
